...
Também pode utilizar a notação de tripla aspa ('''...''' ou 'tres aspas'...'tres aspas') para criar cadeias de várias linhas.
"""

"""
Booleanos
Os valores booleanos representam os valores de verdade: True (verdadeiro) e False (falso).
São comumente utilizados em expressões condicionais e operações lógicas.
Por exemplo:
"""
